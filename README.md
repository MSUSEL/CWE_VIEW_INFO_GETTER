...
python3 ./Add_Other_Node/02_process/add_other.py -in ./Get_CWE_1000_info/04_product/CWE_$view_id-info.json -out Add_Other_Node/04_product/CWE-$view_id-_w_other_unknown.json
