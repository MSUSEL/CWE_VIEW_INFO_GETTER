...
python3 ./Get_CWE_Relation_Info/02_process/Get_Rel_info.py -o ./Get_CWE_Relation_Info/04_product/full_CWE_$view_id.json -json_path ./Get_CWE_1000_info/04_product/CWE_$view_id-info.json -n $number_of_threads
